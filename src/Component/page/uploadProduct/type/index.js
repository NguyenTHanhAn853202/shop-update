    ...
    return (
        <div className={cx('wrapper')}>
            <div className={cx('input')}>
                <Input onChange={(e)=>setInfo((prop=>({...prop,size:e.target.value})))} value={info.size} ref={sizeRef} w70 className={cx('size')} placeholder="size" />
                ...
                <Input onChange={(e)=>setInfo((prop=>({...prop,number:e.target.value*1})))} value={info.number} ref={numberRef} w70 type="number" min={1} className={cx('number')} placeholder="Số lượng" />
            </div>
